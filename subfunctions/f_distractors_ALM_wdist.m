function [ struct_out ] = f_distractors_ALM_wdist(saving_folder, save_fig_flag, N_trials_distr, p, s_cd, s_unpert,...
...
[ rp_vec_early, r_in_early ] = run_RNN_left_wdist( params, r_in );
...
[ rp_vec_late, r_in_late ] = run_RNN_left_wdist( params, r_in );
